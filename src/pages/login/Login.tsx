...
const Child = () => {
  ...
  const handlerRedirection = () => {
    ...
    signInWithGoogle().then((userInfo: any) => {
      ...
      dispatch(userActions.addUser({ displayName, email, photoURL, uid, shopUID }))
      setloading(false)
      navigate('/home')
    })
  }
    ...
    <div className='login-container'>
      <div className='login-content-container'>
        ...
        <div>
          <h1>Wall.</h1>
          <p>
            Welcome to the platform that allows you to manage your store quickly and efficiently
          </p>
          <Button loading={loading} icon={<ArrowRight />} auto onClick={() => handlerRedirection()}>
            Login With Google
          </Button>
        </div>
      </div>
